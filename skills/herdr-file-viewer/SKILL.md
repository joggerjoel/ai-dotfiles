...
<!-- VENDORED VERBATIM from the herdr-file-viewer plugin — do not hand-edit.
     Source: smarzban/herdr-file-viewer @ v1.15.0 (commit 71d4c1c), path
     skills/herdr-file-viewer/SKILL.md. Re-vendor after a plugin upgrade:
       cp "$(herdr plugin list --json | python3 -c 'import json,sys; print(json.load(sys.stdin)["result"]["plugins"][0]["plugin_root"])')/skills/herdr-file-viewer/SKILL.md" \
          skills/herdr-file-viewer/SKILL.md
     then restore this comment block. -->
